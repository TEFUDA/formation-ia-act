...
function SuccessContent() {
  ...
  const templates = pack === "essentiel" ? TEMPLATES_DATA.essentiel : TEMPLATES_DATA.complet;
                  ...
                  <div className="flex flex-col lg:flex-row gap-6">
                    <div className="flex-1">
                      ...
                      <p className="text-white/60 mb-4">
                        Vous avez les documents. Obtenez maintenant les connaissances et le certificat pour les utiliser correctement.
                      </p>
                      ...
                      <div className="space-y-2 mb-6">
                        {[
                          ...
                          "Acces 12 mois a la plateforme",
                          "Support prioritaire",
                        ].map((feature, i) => (
                          <div key={i} className="flex items-center gap-2 text-white/70 text-sm">
                            <div className="w-4 h-4 text-[#00FF88]">
                              <Icons.Check />
                            </div>
                            {feature}
                          </div>
                    ...
                    <div className="lg:w-64 flex flex-col justify-center">
                      <div className="text-center mb-4">
                        <div className="flex items-center justify-center gap-2 mb-1">
                          <span className="text-white/40 line-through text-lg">500 EUR</span>
                          <span className="bg-[#FF4444] text-white text-xs font-bold px-2 py-0.5 rounded">-50%</span>
                        </div>
                        <div className="text-4xl font-bold text-[#FF6B00]">250 EUR</div>
              ...
              <div className="p-6 sm:p-8">
                <div className="flex flex-col lg:flex-row gap-6">
                  <div className="flex-1">
                    ...
                    <p className="text-white/60 mb-4">
                      Vous avez les templates, mais etes-vous vraiment conforme ? Notre audit automatise analyse votre situation en 15 minutes et genere un rapport personnalise.
                    </p>

                    <div className="grid sm:grid-cols-2 gap-3 mb-6">
                      {[
                        { icon: "📋", text: "30 questions analyse" },
                        { icon: "📊", text: "Score de conformite" },
                        { icon: "📄", text: "Rapport PDF personnalise" },
                        { icon: "🎯", text: "Plan action prioritaire" },
                      ].map((item, i) => (
                        <div key={i} className="flex items-center gap-2 text-white/70 text-sm">
                          <span>{item.icon}</span>
                          {item.text}
                  ...
                  <div className="lg:w-64 flex flex-col justify-center">
                    <div className="text-center mb-4">
                      <p className="text-white/40 text-sm mb-1">A partir de</p>
                      <div className="text-4xl font-bold text-[#8B5CF6]">499 EUR</div>
