  ...
  return (
    <div className="flex items-center gap-2">
      <div className="bg-[#FF4444]/20 px-3 py-1 rounded-lg">
        <span className="text-[#FF4444] font-mono font-bold text-lg">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-white/60 text-lg mb-6">
              Votre Pack {currentPack.name} ({currentPack.templates} templates) est prêt.
            </p>

            {/* Download Button */}
            <motion.a
              href="/api/templates/download" // À configurer
            ...
            >
              ...
              Télécharger mes templates
            </motion.a>

            <p className="text-white/40 text-sm mt-4">
              📧 Un email avec le lien de téléchargement vous a également été envoyé.
            </p>
          </motion.div>
          ...
          {/* Upsell 1: Formation (si pas Bundle) */}
                  ...
                  <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-3">
                        <span className="bg-[#FF6B00]/20 text-[#FF6B00] text-xs font-bold px-3 py-1 rounded-full">
                          UPSELL EXCLUSIF -50%
                        </span>
                      </div>
                      ...
                      <p className="text-white/60 mb-4">
                        Vous avez les documents. Obtenez maintenant les <strong className="text-white">connaissances et le certificat</strong> pour les utiliser correctement.
                      </p>

                      <div className="space-y-2 mb-6">
                        {[
                          "6 modules de formation (8h de contenu)",
                    ...
                    <div className="lg:w-64 flex flex-col justify-center">
                      ...
                      <motion.a
                        href="https://buy.stripe.com/FORMATION_UPSELL" // À remplacer
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                        className="w-full py-4 bg-gradient-to-r from-[#FF6B00] to-[#FF4444] text-white font-bold rounded-xl text-center flex items-center justify-center gap-2"
                      >
                      ...
                      <button
                        onClick={() => setUpsell1Dismissed(true)}
                        className="text-white/30 hover:text-white/50 text-sm mt-3 transition-colors"
                      >
            ...
            <HoloCard glow="#8B5CF6">
              <div className="p-6 sm:p-8">
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="bg-[#8B5CF6]/20 text-[#8B5CF6] text-xs font-bold px-3 py-1 rounded-full">
                        NOUVEAU
                      </span>
                    </div>
                    ...
                    <p className="text-white/60 mb-4">
                      Vous avez les templates, mais <strong className="text-white">êtes-vous vraiment conforme ?</strong> Notre audit automatisé analyse votre situation en 15 minutes et génère un rapport personnalisé de 30 pages.
                    </p>

                    <div className="grid sm:grid-cols-2 gap-3 mb-6">
                      {[
                        { icon: "📋", text: "30 questions d'analyse" },
                        { icon: "📊", text: "Score de conformité détaillé" },
                        { icon: "📄", text: "Rapport PDF personnalisé" },
                        { icon: "🎯", text: "Plan d'action prioritaire" },
                        { icon: "⚠️", text: "Identification des risques" },
                        { icon: "💡", text: "Recommandations concrètes" },
                      ].map((item, i) => (
                        <div key={i} className="flex items-center gap-2 text-white/70 text-sm">
                          <span>{item.icon}</span>
                          {item.text}
                  ...
                  <div className="lg:w-64 flex flex-col justify-center">
                    <div className="text-center mb-4">
                      ...
                      <p className="text-white/40 text-xs">HT • 3 formules disponibles</p>
                    </div>

                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                      <Link
                        href="/audit"
                        className="w-full py-4 bg-[#8B5CF6] text-white font-bold rounded-xl text-center flex items-center justify-center gap-2"
                      >
                        Découvrir l'audit
                        <div className="w-5 h-5"><Icons.ArrowRight /></div>
                      </Link>
            ...
            <HoloCard glow="#00F5FF">
              <div className="p-6">
                ...
                <div className="space-y-4">
                  {[
                    { num: 1, title: "Téléchargez vos templates", desc: "Cliquez sur le bouton ci-dessus ou utilisez le lien dans votre email", done: false },
                    { num: 2, title: "Personnalisez avec vos informations", desc: "Ajoutez votre logo, vos coordonnées et adaptez le contenu", done: false },
                    { num: 3, title: "Commencez par le registre IA", desc: "Listez tous les systèmes d'IA utilisés dans votre entreprise", done: false },
                    { num: 4, title: "Classifiez vos risques", desc: "Utilisez la matrice pour déterminer le niveau de risque de chaque système", done: false },
                  ].map((step) => (
                    <div key={step.num} className="flex items-start gap-4">
                      <div className="w-8 h-8 rounded-full bg-[#00F5FF]/20 flex items-center justify-center flex-shrink-0">
                        <span className="text-[#00F5FF] font-bold text-sm">{step.num}</span>
                      </div>
                      <div>
          ...
          >
            <p className="text-white/40 text-sm">
              ...
              <a href="mailto:support@formation-ia-act.fr" className="text-[#00F5FF] hover:underline">
