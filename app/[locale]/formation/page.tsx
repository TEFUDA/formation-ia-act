                ...
                <div className="relative bg-[#0A0A1B]/90 backdrop-blur-xl rounded-2xl border border-[#FF4444]/20 p-6">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      { metric: "Très cher", label: "si cabinet externe", icon: "🏢" },
                    ].map((item, i) => (
                      <motion.li 
                        key={i}
                        initial={{ opacity: 0, x: -20 }}
                ...
                <div className="relative bg-[#0A0A1B]/90 backdrop-blur-xl rounded-2xl border border-[#00FF88]/20 p-6">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      { metric: "Accessible", label: "finançable OPCO", icon: "💎" },
                    ].map((item, i) => (
                      <motion.li 
                        key={i}
                        initial={{ opacity: 0, x: 20 }}
                ...
                <div className="space-y-4 text-white/60">
                  ...
                  <ul className="space-y-2 my-4">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Séminaires juridiques hors de prix (incompréhensibles)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#FF4444]">✗</span>
                  ...
                  <p className="text-white">
                    ...
                    Et une solution accessible finançable par votre OPCO.
                  </p>
                </div>
              </div>
            </HoloCard>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                objection: "\"Est-ce vraiment nécessaire pour mon entreprise ?\"",
                response: "Une amende AI Act peut atteindre 35M€ ou 7% du CA. Faites le diagnostic gratuit pour savoir si vous êtes concerné — c'est sans engagement.",
                icon: "💰"
              },
              {
              ...
              <div className="p-8">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                    <p className="text-white/40 text-sm mb-4">Financement OPCO disponible</p>
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        <span className="text-2xl">💰</span>
                        <div>
                          <p className="text-white font-semibold">Jusqu'à 100% de prise en charge</p>
                          <p className="text-white/60 text-sm">Selon votre OPCO et votre situation</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-2xl">📋</span>
                        <div>
                          <p className="text-white font-semibold">On s'occupe de tout</p>
                          <p className="text-white/60 text-sm">Montage du dossier + facturation directe OPCO</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-2xl">✅</span>
                        <div>
                          <p className="text-white font-semibold">Formation certifiée Qualiopi</p>
                          <p className="text-white/60 text-sm">Éligible à tous les OPCO</p>
                        </div>
                      </div>
                    </div>
                    <p className="text-white/30 text-xs text-center mt-4">*Demandez votre éligibilité lors du diagnostic gratuit</p>
                  </div>
                </div>
              </div>
            </HoloCard>
      ...
      <section className="relative z-10 py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              {
                objection: "\"Comment être sûr que c'est efficace ?\"",
                answer: "Plus de 800 professionnels formés. 94% se disent prêts à affronter un contrôle après la formation. Résultats mesurables, pas des promesses.",
                proof: "→ 847 professionnels certifiés, satisfaction 4.8/5",
                icon: "✅",
                color: "#00FF88"
              },
              {
          ...
          >
            <p className="text-white/60 text-lg mb-4">
              Le vrai risque n&apos;est pas d&apos;investir dans votre conformité.<br/>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: "Quelle différence avec un cabinet de conseil ?", a: "Un cabinet conseil facture très cher pour un accompagnement AI Act. Notre solution tout-en-un vous donne tous les outils pour être autonome et maîtriser votre conformité. On vous explique tout lors du diagnostic gratuit." },
            ].map((faq, i) => (
              <motion.details 
                key={i}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/30">
                ...
                <li><a href="#audit-gratuit" className="hover:text-white transition-colors">Audit Gratuit</a></li>
