...
const plans = [
  { id: 'solo', name: 'Solo', price: 500, originalPrice: 750, users: '1', color: '#00F5FF', features: ['1 utilisateur', '6 modules complets', 'Certificat officiel', '12 mois d\'accès', 'Support email'] },
  { id: 'equipe', name: 'Équipe', price: 2000, originalPrice: 3000, users: '5', color: '#00FF88', popular: true, features: ['5 utilisateurs', '6 modules complets', 'Certificats officiels', 'Dashboard admin', 'Support prioritaire', 'Webinaires exclusifs'] },
  { id: 'enterprise', name: 'Enterprise', price: 18000, originalPrice: 25000, users: '50', color: '#8B5CF6', features: ['50 utilisateurs', '6 modules complets', 'Certificats officiels', 'Dashboard avancé', 'Account manager dédié', 'Formation sur-mesure'] },
];
      ...
      <section className="relative z-10 py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <motion.div 
            ...
            className="text-center mb-12"
          >
            <span className="text-[#00FF88] text-sm font-medium uppercase tracking-widest">L'offre complète</span>
          ...
          <HoloCard glow="#00FF88">
            <div className="p-6 sm:p-8">
              ...
              <div className="space-y-3">
                {[
                  { item: "6 modules de formation vidéo (8h)", value: 2000 },
                  { item: "Quiz de validation avec correction détaillée", value: 200 },
                  { item: "Certificat officiel vérifiable (QR code)", value: 300 },
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xl text-white/30 line-through">4 747€</span>
                </div>
                ...
                >
                  <p className="text-[#00FF88] font-bold text-lg">
                    🎉 Vous économisez 4 247€ (89% de réduction)
                  </p>
                </motion.div>
              </div>
            </div>
                  ...
                  <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">2 000€ HT</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-white/60">Prise en charge OPCO</span>
                        <span className="text-[#00FF88]">-2 000€</span>
                      </div>
                    ...
                    <p className="text-white/30 text-xs text-center mt-4">*Selon conditions OPCO</p>
                  </div>
                </div>
              </div>
            </HoloCard>
            ...
            >
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="text-center sm:text-right">
                  <p className="text-white/30 text-sm line-through">750€</p>
                ...
                <div className="relative">
                  ...
                  <HoloCard glow={plan.color}>
                    <div className="p-6">
                      ...
                      <div className="mb-6">
                        <span className="text-white/30 line-through text-lg">{plan.originalPrice}€</span>
                        <span className="text-4xl font-black ml-2" style={{ color: plan.color }}>{plan.price}€</span>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: "La formation est-elle vraiment certifiante ?", a: "Oui. Vous recevez un certificat officiel avec QR code vérifiable, attestant de votre formation Art. 4 AI Act. Ce certificat est présentable en cas de contrôle." },
              ...
              { q: "Combien de temps pour terminer la formation ?", a: "8h de contenu, à suivre à votre rythme sur 12 mois. La plupart terminent en 2-3 semaines à raison de 1h par jour." },
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}>
            <HoloCard glow="#FF6B00">
              <div className="p-8 sm:p-12 text-center">
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Link href="/checkout?plan=solo" className="inline-flex items-center gap-3 bg-gradient-to-r from-[#FF6B00] to-[#FF4444] text-white font-bold px-10 py-5 rounded-xl text-lg">
      ...
      <footer className="relative z-10 py-12 px-6 border-t border-white/5 pb-24 sm:pb-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center text-sm text-white/20">
            <p>© 2024 Formation-IA-Act.fr • Organisme de formation n° 12345678901</p>
          </div>
        </div>
      </footer>
    </div>
